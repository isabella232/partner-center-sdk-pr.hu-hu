...
Az **Előfizetés** erőforrás egy előfizetés életciklusát jelöli, és olyan tulajdonságokat tartalmaz, amelyek meghatározzák az előfizetés életciklusának államát.
...
| commitmentEndDate    | sztring UTC dátum-idő formátumban                                | Az előfizetés kötelezettségvállalásának záró dátuma, dátum-idő formátumban. A nem automatikusan megújítható előfizetések esetén ez egy távoli, távoli dátumot jelent a jövőben.       |
| status               | sztring                                                        | Az előfizetés állapota: "nincs", "aktív", "függőben", "felfüggesztve", "lejárt" vagy "törölve".                                                                                                         |
...
| isTrial              | boolean                                                       | Egy érték, amely jelzi, hogy próba-előfizetésről van-e szó.                                                                                                                      |
...
| contractType (szerződés típusa)         | sztring                                                        | Csak olvasható. A szerződés típusa: "subscription", "productKey" vagy "redemptionCode".                                                                                           |
...
| Tulajdonság           | Típus                               | Description                           |
|--------------------|------------------------------------|---------------------------------------|
| offer              | [Hivatkozás](utility-resources.md#link) | Lekérte vagy beállítja az ajánlatot.               |
| parentSubscription (parentSubscription) | [Hivatkozás](utility-resources.md#link) | Lekérte vagy beállítja a szülő-előfizetést. |
| product            | [Hivatkozás](utility-resources.md#link) | Lekérte az előfizetéshez társított terméket. |
| Sku                | [Hivatkozás](utility-resources.md#link) | Lekérte az előfizetéshez társított termékváltozatot. |
| availability       | [Hivatkozás](utility-resources.md#link) | Lekérte az előfizetéshez társított termékváltozat elérhetőségét. |
| activationLinks (aktiválási hivatkozás)    | [Hivatkozás](utility-resources.md#link) | Lekérte az előfizetéshez társított aktiválási hivatkozások listáját. |
| Önálló               | [Hivatkozás](utility-resources.md#link) | Az ön-URI.                         |
| Következő               | [Hivatkozás](utility-resources.md#link) | Az elemek következő oldala.               |
| Előző           | [Hivatkozás](utility-resources.md#link) | Az elemek előző oldala.           |
...
| Tulajdonság   | Típus                                                           | Description                                                          |
|------------|----------------------------------------------------------------|----------------------------------------------------------------------|
| skuId (termékváltozatazonosító)      | sztring                                                         | Egy GUID formátumú sztring, amely azonosítja a termék termékváltozatát.             |
...
| expiresAfter      | sztring UTC dátum-idő formátumban | A beállítás lejárati időbélyege. Ha null értékű, az azt jelenti, hogy nincs lejárati ideje. |
