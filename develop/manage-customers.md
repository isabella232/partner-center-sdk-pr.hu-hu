...
## <a name="look-up-a-customer"></a>Ügyfél ki keresse

- [Egy ügyfél lekérése azonosító alapján](get-a-customer-by-id.md)
- [Ügyfél lekérte a vállalat neve vagy tartománya alapján](get-a-customer-by-name.md)
- [Az ügyfelek listájának lekérése](get-a-list-of-customers.md)

## <a name="manage-customer-orders-and-subscriptions"></a>Ügyfélrendelések és -előfizetések kezelése
...
- [Egy ügyfél összes előfizetésének lekérte](get-all-of-a-customer-s-subscriptions.md)
- [Egy előfizetés becenevének frissítése](update-the-nickname-for-a-subscription.md)

## <a name="manage-customer-account-details"></a>Ügyfélfiók részleteinek kezelése
...
## <a name="manage-user-accounts-and-assign-licenses"></a>Felhasználói fiókok kezelése és licencek hozzárendelése

- [Felhasználói fiókok létrehozása egy ügyfélnél](create-user-accounts-for-a-customer.md)
- [Ügyfél felhasználói fiókjainak törlése](delete-user-accounts-for-a-customer.md)
